Public Class frmRepDescuentoTipoDet
    ...
    Private Sub PrintableComponentLink1_CreateReportHeaderArea(ByVal sender As System.Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs)
        ...
        Dim reportHeader As String = vbNewLine & "Reporte Detalle de Descuentos por Tipo " & _
        ...
        Try
            ...
            vSQL = " SELECT " & _
                ...
                "	CONCAT( 		cef.Codigo, 		' ', 		cef.Descripcion, 		 ' - Inter: ', " & _
                   "   cast(if(cef.Interlocutor is null,'',cef.Interlocutor) as unsigned), ' Pts: ', cast(if(cef.Puntos is null,'',cef.Puntos) as unsigned)) AS CEF  ,tp.EsVehiculo, tp.EsTelefono, tp.EsServicio " & _
                "FROM " & _
