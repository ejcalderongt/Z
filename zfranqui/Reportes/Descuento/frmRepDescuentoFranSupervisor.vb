Public Class frmRepDescuentoFranSupervisor
    ...
    Private Sub Llenar_Grid()
        ...
        Try
            ...
            vSQL = "    SELECT " & _
                   ...
                   "   cast(if(cef.Interlocutor is null,'',cef.Interlocutor) as unsigned), ' Pts: ', cast(if(cef.Puntos is null,'',cef.Puntos) as unsigned)) AS CEF , csp.Nombre AS Supervisor " & _
                   "   FROM " & _
                   ...
                   "   INNER JOIN cefSupervisor AS csp ON cef.IdSupervisor = csp.IdSupervisor " & _
            ...
            If GridView1.RowCount > 0 Then
                ...
                GridView1.Columns("Supervisor").GroupIndex = 0
                GridView1.Columns("CEF").GroupIndex = 1
                GridView1.Columns("Franquiciado").GroupIndex = 2
