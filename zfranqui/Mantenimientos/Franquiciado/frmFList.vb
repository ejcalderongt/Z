Public Class frmFList
    ...
    Private Sub frmFList_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        Listar_Franquiciados()
    End Sub

    Private Sub frmFList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Listar_Franquiciados()
    End Sub
    ...
    Private Sub mnuNuevo_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles mnuNuevo.ItemClick
        Nuevo_Franqui() : Listar_Franquiciados()
    End Sub
