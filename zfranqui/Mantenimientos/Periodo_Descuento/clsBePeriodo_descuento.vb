Public Class clsBePeriodo_descuento
	Implements ICloneable

	Private mIdPeriodo As Integer = 0
	Private mNombre As String = ""
	Private mDias As Integer = 0
	...
	Sub New(ByRef IdPeriodo As Integer, ByVal Nombre As String, ByVal Dias As Integer, ByVal fec_agr As Date, ByVal fec_mod As Date, ByVal user_agr As Integer, ByVal user_mod As Integer)
		mIdPeriodo = IdPeriodo
		mNombre = Nombre
		mDias = Dias
		mFec_agr = Fec_agr
		mFec_mod = Fec_mod
